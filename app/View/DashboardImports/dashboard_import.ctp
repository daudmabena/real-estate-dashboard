...
<?php
	...
	echo "<select id='uploadType' name='uploadType'><option value='0'>--Select--</option><option value='1'>By Zipcode</option><option value='2'>By City</option><option value='3'>By Zipcode for Chart</option></select>";	
